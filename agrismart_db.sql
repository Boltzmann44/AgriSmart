...
--
-- Host: 127.0.0.1
-- Creato il: Ott 08, 2024 alle 16:47
...
(56, 'Sezione 1', 'Mais', 15, '2024-10-07', '2025-04-07', 7),
(57, 'Sezione 2', 'Mele', 23, '2024-10-07', '2025-01-07', 7),
(59, 'Sezione 3', 'Arance', 5, '2024-10-07', NULL, 7);
...
(24, 'Lamborghini', 'Gallardo', 75, '2024-10-03', '2024-10-05', './img-users/6703fb03f2f902.01084703.jpg', 7);
...
--
ALTER TABLE `campi`
  MODIFY `id_campo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT per la tabella `prodotti_market`
--
ALTER TABLE `prodotti_market`
  MODIFY `id_prodotto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT per la tabella `risorse`
--
ALTER TABLE `risorse`
  MODIFY `id_risorsa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `veicoli`
  MODIFY `id_veicolo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
